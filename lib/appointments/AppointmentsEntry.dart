...
class AppointmentsEntry extends StatelessWidget {
                      ...
                      child : ListView(
                          children : [
                                ...
                                trailing : IconButton(
                                    ...
                                    onPressed : () async {
                                      ...
                                      String chosenDate = await utils.selectDate(
                                          inContext, appointmentsModel, appointmentsModel.entityBeingEdited.appointmentDate
                                      );
                                      if (chosenDate != null) {
                                        appointmentsModel.entityBeingEdited.appointmentDate = chosenDate;
                                      }
                                    }
                                )
                            ),
                            ...
                            ListTile(
                                ...
                                title : Text("Time"),
                                subtitle : Text(appointmentsModel.appointmentTime == null ? "" : appointmentsModel.appointmentTime),
                                trailing : IconButton(
                                    icon : Icon(Icons.edit),
                                    color : Colors.blue,
  ...
  Future _selectTime(BuildContext inContext) async {
    ...
    if (appointmentsModel.entityBeingEdited.appointmentTime != null) {
      ...
      // Create a DateTime using the hours, minutes and a/p from the appointmentTime.
    ...
    if (picked != null) {
      appointmentsModel.entityBeingEdited.appointmentTime = "${picked.hour},${picked.minute}";
